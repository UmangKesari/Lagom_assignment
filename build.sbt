import io.apigee.trireme.node10.node.http
...
lazy val `hello-external-api` = (project in file("hello-external-api"))
  .settings(
    libraryDependencies ++= Seq(
      lagomScaladslApi
    )
...
lazy val `hello-external-impl` = (project in file("hello-external-impl"))
  .enablePlugins(LagomScala)
  .settings(
    libraryDependencies ++= Seq(
      lagomScaladslPersistenceCassandra,
